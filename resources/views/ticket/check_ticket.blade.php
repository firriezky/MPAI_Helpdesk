                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn text-light btn-success btn-user btn-block">
                                            {{ __('Login') }}
                                        </button>
                                    </div>
                                ...
                                Silakan Daftar Menggunakan Nomor Telepon Aktif Telegram</h5>
                                <hr>
