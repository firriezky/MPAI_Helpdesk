                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @elseif(session() -> has('error'))
                                    ...
                                    <div class="alert alert-primary alert-dismissible fade show mx-2 my-2" role="alert">
                                        ...
                                        <strong>{{ Session::get('error') }}</strong> You should check in on some of those
                                        fields below.
                                    </div>
                                @endif
                            ...
                            <div class="col-lg-6 my-auto mx-auto">
                                <lottie-player src="https://assets6.lottiefiles.com/private_files/lf30_7z3j6ycb.json"
                                    background="transparent" speed="1" class="my-auto mx-auto img-fluid" loop autoplay>
                                </lottie-player>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5 justify-content-center">
                                    ...
                                    <div class="col-12">
                                        <h4>Request Bantuan</h4>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12 col-lg-6">
                                            <a href="{{ url('/ticket/new-ticket') }}"
                                                class="btn btn-primary btn-block btn-icon-split mt-3 ">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <a href="{{ url('/ticket/find') }}"
                                                class="btn btn-success btn-block btn-icon-split mt-3 ">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-flag"></i>
                                                </span>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <a href="{{ url('/ticket/new-ticket') }}"
                                                class="btn btn-warning btn-block btn-icon-split mt-3 ">
                                                <span class="icon text-white-50">
                                                    <i class="fas fa-flag"></i>
                                                </span>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-6">
                                            <a href="https://ft.badanmentoring.org"
                                                class="btn btn-border border-primary btn-block btn-icon-split mt-3 ">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <a href="https://fit.badanmentoring.org"
                                                class="btn btn-border border-primary btn-block btn-icon-split mt-3 ">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <a href="https://fik.badanmentoring.org"
                                                class="btn btn-border border-primary btn-block btn-icon-split mt-3 ">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <a href="https://fkeb.badanmentoring.org"
                                                class="btn btn-border border-primary btn-block btn-icon-split mt-3 ">
